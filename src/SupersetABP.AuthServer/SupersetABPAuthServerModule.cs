...
public class SupersetABPAuthServerModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("SupersetABP");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<SupersetABPDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}SupersetABP.Domain", Path.DirectorySeparatorChar)));
            });
        }
